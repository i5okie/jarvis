...
class SalesOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sales_order" do
    assert_difference('SalesOrder.count') do
      post sales_orders_url, params: { sales_order: { customer_id: @sales_order.customer_id, date: @sales_order.date, number: @sales_order.number, shipping_address: @sales_order.shipping_address } }
    end
  ...
  test "should update sales_order" do
    patch sales_order_url(@sales_order), params: { sales_order: { customer_id: @sales_order.customer_id, date: @sales_order.date, number: @sales_order.number, shipping_address: @sales_order.shipping_address } }
