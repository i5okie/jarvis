class ShippingAddressesController < ApplicationController
  ...
  private
    ...
    def shipping_address_params
      params.require(:shipping_address).permit(:address_alias, :address_type, :address_1, :address_2, :address_city, :address_country, :address_state, :address_zip, :customer_id)
    end
end
